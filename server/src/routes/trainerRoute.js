...
const { getAllBookings, updateBooking, assignWorkouts, deleteWorkout, viewUserNutrition, createSession } = require('../controllers/trainerControllers')
...
router.get('/usernutrition/:id',trainerAuth,viewUserNutrition)
